...
ansible node1 -m shell -a "echo Hello Ogulcan > /home/ec2-user/testfile2 ; cat testfile2"
```
...
ansible all --list-hosts
ansible all -m ping -o
ansible all -m shell -a "echo Hello Ogulcan > /home/ubuntu/testfile3"
```
...
```bash
ansible node1:node2 -m shell -a "echo Hello Ogulcan > /home/ec2-user/testfile3"
```
